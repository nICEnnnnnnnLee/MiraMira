...
public class RobotConfig {
	...
	public static ConcurrentSet<String> superadmins;
	@Config(description="白名单列表, e.g. [f10000, g10086]表示qq 10000, 和群 10086" )
	public static ConcurrentSet<String> whitelist;
	@Config(description="黑名单列表, e.g. [f10000, g10086]表示qq 10000, 和群 10086")
	public static ConcurrentSet<String> blacklist;
	public static ConcurrentWeakMap<String, Long> musicRecords = new ConcurrentWeakMap<>();
	public static ConcurrentWeakMap<String, List<Music>> musicInfos = new ConcurrentWeakMap<>();
...
//				System.out.println(field.getName() + " - " +(field.getAnnotation(Config.class) == null));
			...
			try {
				...
				if (value != null) {
					if (field.getType().equals(ConcurrentSet.class)) {
						ConcurrentSet<String> set = (ConcurrentSet<String>)value;
